...
function getWCGroups() {
  ...
  const GROUPS = [
    { id:'A', teams:[
      ...
      { id:772,  nameKey:'team_SouthKorea',   tla:'KOR', flag_code:'kr'     },
      { id:798,  nameKey:'team_Czechia',         tla:'CZE', flag_code:'cz'     },
    ]},
    { id:'B', teams:[
      { id:828,  nameKey:'team_Canada',          tla:'CAN', flag_code:'ca'     },
      { id:1060, nameKey:'team_Bosnia', tla:'BIH', flag_code:'ba'  },
      { id:8030, nameKey:'team_Qatar',           tla:'QAT', flag_code:'qa'     },
      { id:788,  nameKey:'team_Switzerland',           tla:'SUI', flag_code:'ch'     },
    ]},
    { id:'C', teams:[
      { id:764,  nameKey:'team_Brazil',          tla:'BRA', flag_code:'br'     },
      { id:815,  nameKey:'team_Morocco',        tla:'MAR', flag_code:'ma'     },
      { id:836,  nameKey:'team_Haiti',           tla:'HAI', flag_code:'ht'     },
      { id:8873, nameKey:'team_Scotland',         tla:'SCO', flag_code:'gb-sct' },
    ]},
    { id:'D', teams:[
      { id:771,  nameKey:'team_USA',             tla:'USA', flag_code:'us'     },
      { id:761,  nameKey:'team_Paraguay',        tla:'PAR', flag_code:'py'     },
      { id:779,  nameKey:'team_Australia',       tla:'AUS', flag_code:'au'     },
      { id:803,  nameKey:'team_Turkey',         tla:'TUR', flag_code:'tr'     },
    ]},
    { id:'E', teams:[
      { id:759,  nameKey:'team_Germany',         tla:'GER', flag_code:'de'     },
      { id:9460, nameKey:'team_Curacao',          tla:'CUW', flag_code:'cw'     },
      { id:1935, nameKey:'team_IvoryCoast', tla:'CIV', flag_code:'ci'     },
      { id:791,  nameKey:'team_Ecuador',         tla:'ECU', flag_code:'ec'     },
    ]},
    { id:'F', teams:[
      { id:8601, nameKey:'team_Netherlands',   tla:'NED', flag_code:'nl'     },
      { id:766,  nameKey:'team_Japan',           tla:'JPN', flag_code:'jp'     },
      { id:792,  nameKey:'team_Sweden',          tla:'SWE', flag_code:'se'     },
      { id:802,  nameKey:'team_Tunisia',         tla:'TUN', flag_code:'tn'     },
    ]},
    { id:'G', teams:[
